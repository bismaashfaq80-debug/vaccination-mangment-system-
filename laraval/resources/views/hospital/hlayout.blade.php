...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="hospital/images/logos/favicon.png" />
  <link rel="stylesheet" href="hospital/css/styles.min.css" />
</head>
<body>
  <!--  Body Wrapper -->
    ...
    <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center justify-content-center gap-5 mb-2 mb-lg-0">
        <a class="d-flex justify-content-center" href="#">
          <img src="hospital/images/logos/logo-wrappixel.svg" alt="" width="150">
        </a>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="hospital/images/logos/logo.svg" alt="" />
          </a>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="/request" aria-expanded="false">
  ...
  <script src="./hospital/libs/jquery/dist/jquery.min.js"></script>
  <script src="./hospital/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <script src="./hospital/js/sidebarmenu.js"></script>
  <script src="./hospital/js/app.min.js"></script>
  <script src="./hospital/libs/apexcharts/dist/apexcharts.min.js"></script>
  <script src="./hospital/libs/simplebar/dist/simplebar.js"></script>
  <script src="./hospital/js/dashboard.js"></script>
  <!-- solar icons -->
